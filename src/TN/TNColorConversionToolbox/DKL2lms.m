...
lmsc = [(stdlms(1).*(DKL(1,:).*thr(1)) + stdlms(2).*(DKL(2,:).*thr(2)) ) / (stdlms(1)+stdlms(2));...
        (stdlms(2).*(DKL(1,:).*thr(1)) - stdlms(2).*(DKL(2,:).*thr(2)) ) / (stdlms(1)+stdlms(2));...
        (stdlms(3).*(DKL(1,:).*thr(1)) + stdlms(3).*(DKL(3,:).*thr(3)) ) / (stdlms(1)+stdlms(2));...
        ];
