function varargout = udtmeasBitsPTB3_menu(varargin)
% UDTMEASBITSPTB3_MENU M-file for udtmeasBitsPTB3_menu.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @udtmeasBitsPTB3_menu_OpeningFcn, ...
                   'gui_OutputFcn',  @udtmeasBitsPTB3_menu_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function udtmeasBitsPTB3_menu_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = udtmeasBitsPTB3_menu_OutputFcn(hObject, eventdata, handles) 
