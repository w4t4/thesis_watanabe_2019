function q=QuestCreate_TN(tGuess,tGuessSd,pThreshold,beta,delta,gamma,grain,range,oldq)
...
if nargin<6 | nargin>9
	error('Usage: q=QuestCreate(tGuess,tGuessSd,pThreshold,beta,delta,gamma,[grain],[range],[oldq])')
end
if nargin<7
	grain=0.01;
end
...
if nargin<9
    q=QuestRecompute_TN(q);
else
    q=QuestRecompute_TN(q,oldq);
end
