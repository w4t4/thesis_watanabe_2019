function varargout = ColorCALPTB3(varargin)
% COLORCALPTB3 M-file for ColorCALPTB3.fig
%      COLORCALPTB3, by itself, creates a new COLORCALPTB3 or raises the existing
%      singleton*.
%
%      H = COLORCALPTB3 returns the handle to a new COLORCALPTB3 or the handle to
%      the existing singleton*.
%
%      COLORCALPTB3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COLORCALPTB3.M with the given input arguments.
%
%      COLORCALPTB3('Property','Value',...) creates a new COLORCALPTB3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before udtmeasBitsPTB3_menu_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ColorCALPTB3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ColorCALPTB3

% Last Modified by GUIDE v2.5 22-Mar-2012 15:02:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ColorCALPTB3_OpeningFcn, ...
                   'gui_OutputFcn',  @ColorCALPTB3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ColorCALPTB3 is made visible.
function ColorCALPTB3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ColorCALPTB3 (see VARARGIN)

% Choose default command line output for ColorCALPTB3
...
% UIWAIT makes ColorCALPTB3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ColorCALPTB3_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in NewMeasureButton.
function NewMeasureButton_Callback(hObject, eventdata, handles)
% hObject    handle to NewMeasureButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ColorCALPTB3_start;
