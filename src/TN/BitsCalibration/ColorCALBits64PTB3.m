function varargout = ColorCALBits64PTB3(varargin)
% COLORCALBITS64PTB3 M-file for ColorCALBits64PTB3.fig
%      COLORCALBITS64PTB3, by itself, creates a new COLORCALBITS64PTB3 or raises the existing
%      singleton*.
%
%      H = COLORCALBITS64PTB3 returns the handle to a new COLORCALBITS64PTB3 or the handle to
%      the existing singleton*.
%
%      COLORCALBITS64PTB3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COLORCALBITS64PTB3.M with the given input arguments.
%
%      COLORCALBITS64PTB3('Property','Value',...) creates a new COLORCALBITS64PTB3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before udtmeasBitsPTB3_menu_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ColorCALBits64PTB3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ColorCALBits64PTB3

% Last Modified by GUIDE v2.5 11-Sep-2013 16:57:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ColorCALBits64PTB3_OpeningFcn, ...
                   'gui_OutputFcn',  @ColorCALBits64PTB3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ColorCALBits64PTB3 is made visible.
function ColorCALBits64PTB3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ColorCALBits64PTB3 (see VARARGIN)

% Choose default command line output for ColorCALBits64PTB3
...
% UIWAIT makes ColorCALBits64PTB3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ColorCALBits64PTB3_OutputFcn(hObject, eventdata, handles) 
...
% --------------------------------------------------------------------
function PortNo_Callback(hObject, eventdata, handles)
% hObject    handle to PortNo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of PortNo as text
%        str2double(get(hObject,'String')) returns contents of PortNo as a double
global PORT_NUM;

PORT_NUM = get(hObject, 'String');
...
% --- Executes during object creation, after setting all properties.
function PortNo_CreateFcn(hObject, eventdata, handles)
% hObject    handle to PortNo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
handles.metricdata.PortNo = PORT_NUM;
set(handles.spl, 'String', handles.metricdata.spl);
