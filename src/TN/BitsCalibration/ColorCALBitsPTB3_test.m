function varargout = ColorCALBitsPTB3_test(varargin)
% COLORCALBITSPTB3_TEST M-file for ColorCALBitsPTB3_test.fig
%      COLORCALBITSPTB3_TEST, by itself, creates a new COLORCALBITSPTB3_TEST or raises the existing
%      singleton*.
%
%      H = COLORCALBITSPTB3_TEST returns the handle to a new COLORCALBITSPTB3_TEST or the handle to
%      the existing singleton*.
%
%      COLORCALBITSPTB3_TEST('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COLORCALBITSPTB3_TEST.M with the given input arguments.
%
%      COLORCALBITSPTB3_TEST('Property','Value',...) creates a new COLORCALBITSPTB3_TEST or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before udtmeasBitsPTB3_menu_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ColorCALBitsPTB3_test_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ColorCALBitsPTB3_test

% Last Modified by GUIDE v2.5 29-Jun-2010 17:19:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ColorCALBitsPTB3_test_OpeningFcn, ...
                   'gui_OutputFcn',  @ColorCALBitsPTB3_test_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ColorCALBitsPTB3_test is made visible.
function ColorCALBitsPTB3_test_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ColorCALBitsPTB3_test (see VARARGIN)

% Choose default command line output for ColorCALBitsPTB3_test
...
% UIWAIT makes ColorCALBitsPTB3_test wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ColorCALBitsPTB3_test_OutputFcn(hObject, eventdata, handles) 
